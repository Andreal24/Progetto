...
<body>
    <div class="wrapper">
        <div class="sidebar" data-color="red" data-image="dashboard/img/sidebar-7.jpg">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="dashboard/pages/manager_ordini.jsp">
                            <p>Ordini</p>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link" href="dashboard/pages/manager_carrelli.jsp">
                            <p>Carrelli</p>
                        </a>
                    </li>
                </ul>
        ...
        <div class="main-panel">
            ...
            <!-- End Navbar -->
            <div style="width: 100%; height: 100%; top: 0; left: 0; overflow: hidden;"><img src="img/white-wine.jpg"></div>
