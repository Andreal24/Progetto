				...
				<div class="container">
					...
					<div class="row nav-menu">
						...
						<div class="col-sm-12 columns text-center">
														<ul class="menu">
                                                            <a></a>
                                                            <li><a href="index.jsp" target="_self"><img src="img/blank.png" alt=""/>  Home</a></li>
                                                            <li><a href="chi_siamo.jsp" target="_self"><img src="img/blank.png" alt=""/>  Chi Siamo</a></li>
                                                            <li><a href="marche.jsp" target="_self"><img src="img/blank.png" alt=""/>  I nostri Marchi</a></li>
                                                            <li><a href="vini.jsp" target="_self"><img src="img/blank.png" alt=""/>  Nostri Prodotti </a></li>
                                                            <li><a href="contatti.jsp" target="_self"><img src="img/blank.png" alt=""/>  Contatti</a></li>
                                                            <li><a href="login.jsp" target="_self"><img src="img/login.png" alt=""/>  Accedi</a></li>
                                                            <li><a href="login.jsp" target="_self"><img src="img/cart.png" alt=""/>  Carrello</a></li>
							</ul>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        ...
                        <ul class="pricing-content">
                            <li><strong>Codice:</strong>  <%= res.getString("codice") %></li>
                            ...
                            <li><strong>Bottiglie:</strong>  <%= res.getString("pezzi") %></li>
                        </ul>
                        <a href="#" class="pricingTable-signup" onClick="alert('Effettua prima il login')">Aggiungi al carrello</a>
                    </div>
                </div>
