    ...
    <div class="wrapper">
        <div class="sidebar" data-color="red" data-image="dashboard/img/sidebar-7.jpg">
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="index_logged.jsp" class="simple-text">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="dashboard/pages/user_profilo.jsp">
                            <p>Profilo</p>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link" href="dashboard/pages/user_ordini.jsp">
                            <p>Ordini</p>
                        </a>
                    </li>
                </ul>
        ...
        <div class="main-panel">
            ...
            <!-- End Navbar -->
            <div style="width: 100%; height: 100%; top: 0; left: 0; overflow: hidden;"><img src="img/cover-dash.jpg"></div>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            ...
                            <a href="index_logged.jsp">e-Wine</a>
                        </p>
                    </nav>
                </div>
            </footer>
