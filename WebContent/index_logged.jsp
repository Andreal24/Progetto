				...
				<div class="container align-vertical">
					<div class="row">
						<div class="col-md-7 col-sm-8">
							...
							<h1 class="text-white">Scopri i nostri miglior vini di eccellenza </h1>
							<p class="lead text-white">Prodotti di qualità </p>
							<a target="_self" href="chi_siamo_logged.jsp" class="btn btn-primary btn-white inner-link">Per saperne di più</a>
							 <a class="logout" method="post" action="logout"><a onClick="return confirm('Sei sicuro di voler effettuare il logout?')" href="registrati.jsp" class="btn btn-primary btn-filled inner-link" target="_self">Iscriviti per la degustazione</a>
						</div></a>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<h1 class="text-white">Seguici su i social Network per avere delle info sempre aggiornate</h1>	
                                                                                         <li>
